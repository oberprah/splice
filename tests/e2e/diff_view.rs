...
"   16     pub fn multiply(&self, a:   │  16     pub fn mul(&self, a: i32, b:    "
"    ↪ i32, b: i32) -> i32 {           │   ↪ i32) -> i32 {                       "
"   17         a * b                   │  17                                     "
"                                      │   ↪ a.checked_mul(b).unwrap_or(0)       "
"   18     }                           │                                         "
"   19                                 │                                         "
"   20     pub fn divide(&self, a: i32 │                                         "
"    ↪ b: i32) -> Option<i32> {        │                                         "
"   21         if b == 0 {             │                                         "
"   22             None                │                                         "
"   23         } else {                │                                         "
...
"                                      │  24     pub fn pow(&self, base: i32,    "
"                                      │   ↪ exp: u32) -> i32 {                  "
"                                      │  25         (0..exp).fold(1, |acc, _    "
"                                      │   ↪ acc * base)                         "
"                                      │  26     }                               "
"                                      │  27                                     "
"   32     pub fn format_result(&self, │  28     pub fn format_result(&self,     "
...
"    2     let               │   2     let                   "
"    ↪ very_long_variable_na │   ↪ very_long_variable_nam    "
"    ↪ e_that_definitely_exc │   ↪ _that_definitely_excee    "
"    ↪ eds_screen_width =    │   ↪ s_screen_width = "this    "
"    ↪ "this is an extremely │   ↪ is an updated extremel    "
"    ↪ long string value tha │   ↪ long string value that    "
"    ↪ should wrap across    │   ↪ should wrap across        "
"    ↪ multiple lines when   │   ↪ multiple lines when       "
"    ↪ displayed in the diff │   ↪ displayed in the diff     "
"    ↪ view";                │   ↪ view";                    "
"                            │   3     let                   "
...
fn diff_view_unified_toggle() {
    ...
    let repo = TestRepo::new();
    repo.add_file("src/main.rs", "line 1\nline 2\nline 3\nline 4\nline 5\n");
    repo.commit("Initial");
    repo.modify_file(
        "src/main.rs",
        "line 1\nline 2 changed\nline 3\nline 4\nline 5\nnew line 6\n",
    ...
    // Navigate: log → files → diff
    h.press(KeyCode::Enter);
    h.press(KeyCode::Enter);

    // Verify side-by-side view first
    h.assert_snapshot(
        r#"
"  1b35a52 · src/main.rs · +2 -1                                                 "
"    1 line 1                          │   1 line 1                              "
"    2 line 2                          │   2 line 2 changed                      "
"    3 line 3                          │   3 line 3                              "
"    4 line 4                          │   4 line 4                              "
"    5 line 5                          │   5 line 5                              "
"                                      │   6 new line 6                          "
