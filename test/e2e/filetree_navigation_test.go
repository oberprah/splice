...
func TestTreeNavigation_BasicStructure(t *testing.T) {
	...
	runner.AssertGolden("filetree_navigation/basic_structure-01-log.golden")
	...
	runner.AssertGolden("filetree_navigation/basic_structure-02-files.golden")
...
func TestTreeNavigation_UpDown(t *testing.T) {
	...
	runner.AssertGolden("filetree_navigation/updown-01-initial.golden")

	// Navigate down with j - cursor moves to next item
	runner.Send(tea.KeyMsg{Type: tea.KeyRunes, Runes: []rune("j")})
	runner.AssertGolden("filetree_navigation/updown-02-after_j.golden")

	// Navigate down again
	runner.Send(tea.KeyMsg{Type: tea.KeyRunes, Runes: []rune("j")})
	runner.AssertGolden("filetree_navigation/updown-03-after_jj.golden")

	// Navigate up with k
	runner.Send(tea.KeyMsg{Type: tea.KeyRunes, Runes: []rune("k")})
	runner.AssertGolden("filetree_navigation/updown-04-after_jjk.golden")

	// Jump to bottom with G
	runner.Send(tea.KeyMsg{Type: tea.KeyRunes, Runes: []rune("G")})
	runner.AssertGolden("filetree_navigation/updown-05-at_bottom.golden")

	// Jump to top with g
	runner.Send(tea.KeyMsg{Type: tea.KeyRunes, Runes: []rune("g")})
	runner.AssertGolden("filetree_navigation/updown-06-back_to_top.golden")
...
func TestTreeNavigation_CollapseExpand(t *testing.T) {
	...
	runner.AssertGolden("filetree_navigation/collapse-01-initial.golden")

	// Cursor on src/ folder - press Enter to collapse
	runner.Send(tea.KeyMsg{Type: tea.KeyEnter})
	// Should show "src/ +105 -2 (4 files)" and hide children
	runner.AssertGolden("filetree_navigation/collapse-02-after_enter.golden")

	// Press Enter again to expand
	runner.Send(tea.KeyMsg{Type: tea.KeyEnter})
	// Should show children again
	runner.AssertGolden("filetree_navigation/collapse-03-after_expand.golden")
	...
	runner.AssertGolden("filetree_navigation/collapse-04-with_space.golden")
...
func TestTreeNavigation_ArrowKeys(t *testing.T) {
	...
	runner.AssertGolden("filetree_navigation/arrows-01-initial.golden")

	// Press left arrow to collapse
	runner.Send(tea.KeyMsg{Type: tea.KeyLeft})
	// lib/ folder should collapse
	runner.AssertGolden("filetree_navigation/arrows-02-after_left.golden")

	// Press left arrow again (should be no-op when already collapsed)
	runner.Send(tea.KeyMsg{Type: tea.KeyLeft})
	// Should remain collapsed
	runner.AssertGolden("filetree_navigation/arrows-03-after_left_noop.golden")

	// Press right arrow to expand
	runner.Send(tea.KeyMsg{Type: tea.KeyRight})
	// lib/ folder should expand
	runner.AssertGolden("filetree_navigation/arrows-04-after_right.golden")

	// Press right arrow again (should be no-op when already expanded)
	runner.Send(tea.KeyMsg{Type: tea.KeyRight})
	// Should remain expanded
	runner.AssertGolden("filetree_navigation/arrows-05-after_right_noop.golden")
...
func TestTreeNavigation_CollapsedPaths(t *testing.T) {
	...
	runner.AssertGolden("filetree_navigation/collapsed_path-01-initial.golden")
	...
	runner.AssertGolden("filetree_navigation/collapsed_path-02-collapsed.golden")

	// Expand src/ again
	runner.Send(tea.KeyMsg{Type: tea.KeyEnter})
	// Should reveal the collapsed path and all files
	runner.AssertGolden("filetree_navigation/collapsed_path-03-expanded.golden")
...
func TestTreeNavigation_EnterFile(t *testing.T) {
	...
	runner.Send(tea.KeyMsg{Type: tea.KeyEnter})
	// Initial files view
	runner.AssertGolden("filetree_navigation/enter_file-01-initial.golden")
	...
	runner.AssertGolden("filetree_navigation/enter_file-02-diff.golden")
	...
	runner.AssertGolden("filetree_navigation/enter_file-03-back_to_tree.golden")
...
func TestTreeNavigation_MixedStatuses(t *testing.T) {
	...
	runner.AssertGolden("filetree_navigation/mixed_statuses-01.golden")
...
func TestTreeNavigation_BinaryFiles(t *testing.T) {
	...
	runner.AssertGolden("filetree_navigation/binary_files-01.golden")
...
func TestTreeNavigation_SingleFileFolder(t *testing.T) {
	...
	runner.AssertGolden("filetree_navigation/single_file_folder-01.golden")
...
func TestTreeNavigation_EmptyTree(t *testing.T) {
	...
	runner.AssertGolden("filetree_navigation/empty_tree-01.golden")
