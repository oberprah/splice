...
func CommitInfo(commit git.GitCommit, width int, bodyMaxLines int, ctx Context) []string {
	var lines []string
...
func renderMetadataLine(commit git.GitCommit, width int, ctx Context) string {
