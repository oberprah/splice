...
func TestDiffState_View_AllLineTypes(t *testing.T) {
	...
	assertDiffViewGolden(t, output, "all_line_types.golden")
}
...
func TestDiffState_View_TokenRendering(t *testing.T) {
	...
	assertDiffViewGolden(t, output, "token_rendering.golden")
}
...
func TestDiffState_View_InlineDiffRendering(t *testing.T) {
	...
	assertDiffViewGolden(t, output, "inline_diff_rendering.golden")
}
